...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="bg-[#F7F7F7] flex text-left py-20">
            <div class="flex-1 my-auto pl-32 pr-10">
                <h1 class="">Slogan</h1>
        ...
        <div class="bg-[#F0C929] px-20 py-10">
            ...
            <div class="flex">
                <div class="bg-white rounded-lg p-10 flex-1 mx-5 shadow-lg">
        ...
        <div class="bg-[#2A1A5E] flex w-full px-32 pt-20 text-white">
            <div class="flex-1 pl-10 pr-32">
