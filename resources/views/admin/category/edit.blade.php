...
<form action="{{route('category.update', ['category' => $category->id])}}" class="mt-10" method="post" enctype="multipart/form-data">
    @csrf
    @method('patch')
    <div class="mb-6">
    ...
    <div class="mb-6">
        ...
        <input name="image" type="file" id="image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full" placeholder="Description" required>
      </div>
