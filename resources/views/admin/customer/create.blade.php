...
<form action="{{route('customer.store')}}" class="mt-10" method="post" enctype="multipart/form-data">
    @csrf
    <div class="mb-6">
    ...
    <div class="mb-6">
        ...
        <input name="no_phone" type="text" id="no_phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="ex: 0812">
    </div>
    <div class="mb-6">
        <label for="location" class="block mb-2 text-sm font-medium text-gray-900">Lokasi</label>
        <input name="location" type="text" id="location" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="ex: Balikpapan">
    </div>
    <div class="mb-6">
